...
public class GCPService {
    ...
    public ResponseUploadDto uploadImage(MultipartFile image) throws IOException {
        ...
        try (InputStream inputStream = image.getInputStream()) {
            Credentials credentials = GoogleCredentials.fromStream(new FileInputStream("/home/icfcatory/Desktop/build/resources/main/project-booker-404207-83e308ade68a.json"));
